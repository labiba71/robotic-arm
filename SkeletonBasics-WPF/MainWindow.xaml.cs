...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
            ...
            using (SkeletonFrame skeletonFrame = e.OpenSkeletonFrame())
            {
                if (skeletonFrame != null)
                {
                    ...
                    if (first != null) {
                        ...
                        Console.WriteLine("Left Elbow:"+angles[1].ToString());
                        //Console.WriteLine("Right Elbow:"+angles[0].ToString());
                        //Console.WriteLine("Left Wrist:" + angles[2].ToString());
                        Console.WriteLine("Right Wrist:" + angles[3].ToString());
                        Console.WriteLine("Left Soldier:" + angles[4].ToString());

                     /*   if (angles[1] < 100 || angles[3] < 150 || angles[4]>150)
                        {
                            if (angles[1] < 100)
                            {
                                cc.sendtoport("1");
                        ...
                        /* if (angles[1] < 100)
                          ...
                          else if (angles[1] > 100 && angles[1] < 180)
                          {
                              cc.sendtoport("0");
                          }
                          else {
        ...
        public byte[] GetVector(Skeleton skeleton)
        {
            ...
            double AngleLeftWrist = AngleBetweenTwoVectors(LeftWrist-LeftElbow,LeftWrist-LeftHand);
            double AngleRightWrist = AngleBetweenTwoVectors(RightWrist-RightElbow,RightWrist-RightHand);
            double AngleLeftShoulder = AngleBetweenTwoVectors(UpVector, LeftShoulder - LeftElbow);


            byte[] Angles = { Convert.ToByte(AngleRightElbow), Convert.ToByte(AngleLeftElbow), Convert.ToByte(AngleLeftWrist), Convert.ToByte(AngleRightWrist), Convert.ToByte(AngleLeftShoulder) };
            return Angles;
        }
